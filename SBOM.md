...
**SBOM Serial:** urn:topic-manager:sbom:1.0.0
...
|-----------|----------|----------|----------------------------|
| Vue.js    | 3.5.13   | MIT      | vuejs.org                  |

## Backend Dependencies

| Component        | Version | License         | Source                              |
|------------------|---------|-----------------|-------------------------------------|
| Flask            | 3.1.0   | BSD-3-Clause    | flask.palletsprojects.com           |
| gunicorn         | 23.0.0  | MIT             | gunicorn.org                        |
| ldap3            | 2.9.1   | LGPL-3.0        | ldap3.readthedocs.io                |
| confluent-kafka  | 2.6.1   | Apache-2.0      | confluent.io / github.com/confluentinc/confluent-kafka-python |
...
| Component     | Version    | License    | Source            |
|---------------|------------|------------|-------------------|
| nginx         | 1.24.x     | BSD-2-Clause | nginx.org       |
